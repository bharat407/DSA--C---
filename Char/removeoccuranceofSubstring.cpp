...
string removeOccurOfSub(string s, string part)
{
    ...
    { // check till the part is not found in main string
...
int main()
{
    ...
    getline(cin, s); // input taking for string with spaces
    cout << "Enter the part of string need to be removed : ";
    getline(cin, part); // a part or substring need to be searched
